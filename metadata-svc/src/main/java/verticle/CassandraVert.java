...
public class CassandraVert extends AbstractVerticle
{
  private static final Logger logger = LoggerFactory.getLogger( CassandraVert.class );
  ...
  private Promise<Void> initializeCassandra()
  {
    ...
    vertx.executeBlocking( () -> {
      try
      {
        ...
        String contactPoint = config().getString( "cassandra.host", "localhost" );
